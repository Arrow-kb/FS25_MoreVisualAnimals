MVA_HandToolHorseBrush = {}


function MVA_HandToolHorseBrush:getHusbandryAndClusterFromNode(superFunc, node)
...
HandToolHorseBrush.getHusbandryAndClusterFromNode = Utils.overwrittenFunction(HandToolHorseBrush.getHusbandryAndClusterFromNode, MVA_HandToolHorseBrush.getHusbandryAndClusterFromNode)